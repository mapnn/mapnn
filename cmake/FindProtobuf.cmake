...
option(BUILD_PROTOBUF "Force to build libprotobuf from sources" ON)
option(PROTOBUF_UPDATE_FILES "Force rebuilding .proto files (protoc should be available)" OFF)
...
if(BUILD_PROTOBUF)
    add_subdirectory("${PROJECT_SOURCE_DIR}/3rdparty/protobuf")
...
install(FILES ${PROJECT_SOURCE_DIR}/3rdparty/protobuf/LICENSE
    DESTINATION license RENAME LICENSE-protobuf.txt)
