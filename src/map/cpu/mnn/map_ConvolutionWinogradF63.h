...
DECLARE_OPTIMAL_MAP(map_ConvolutionWinogradF63);

namespace mapnn {
inline bool map_ConvolutionWinogradF63::request(Operator& op) {
...
inline bool map_ConvolutionWinogradF63::run(Graph* graph, Node* node) {
    ...
    node->setKernel(new mnn_ConvolutionWinogradF63());
    w_pack->setKernel(new mnn_transformWeightF63());
