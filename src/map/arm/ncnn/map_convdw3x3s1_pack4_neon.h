...
DECLARE_OPTIMAL_MAP(map_convdw3x3s1_pack4_neon);

namespace mapnn {
inline bool map_convdw3x3s1_pack4_neon::request(Operator& op) {
...
inline bool map_convdw3x3s1_pack4_neon::run(Graph* graph, Node* node) {
    ...
    node->setKernel(new ncnn_convdw3x3s1_pack4_neon());
