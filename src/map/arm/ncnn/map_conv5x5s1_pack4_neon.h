...
DECLARE_OPTIMAL_MAP(map_conv5x5s1_pack4_neon);

namespace mapnn {
inline bool map_conv5x5s1_pack4_neon::request(Operator& op) {
...
inline bool map_conv5x5s1_pack4_neon::run(Graph* graph, Node* node) {
    ...
    node->setKernel(new ncnn_conv5x5s1_pack4_neon());
